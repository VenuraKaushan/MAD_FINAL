                ...
                if (snapshot.exists()){
                    ...
                    mAdapter.setOnItemClickListener(object : EmpAdapter.onItemClickListener{
                        override fun onItemClick(position: Int) {
                            ...
                            intent.putExtra("placeId", empList[position].placeId)
                            intent.putExtra("placeName", empList[position].placeName)
                            intent.putExtra("description", empList[position].description)
                            intent.putExtra("importance", empList[position].importance)
